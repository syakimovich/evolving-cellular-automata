package org.yakimovich.evolca.example.universe5sum;

import org.yakimovich.evolca.Universe;
import org.yakimovich.evolca.Universe5Sum;
...
public class Random8States {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        for(int i = 0; i < 10; i++){
            ...
            int[][] thresholds = ArrayUtils.createRandom2DIntArray(numberOfStates, numberOfStates - 1, numberOfStates * 4);
            Universe u = new Universe5Sum(initialCells, thresholds, numberOfStates, isCircular);
            universes.add(u);
        }
