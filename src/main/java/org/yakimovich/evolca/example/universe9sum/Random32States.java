package org.yakimovich.evolca.example.universe9sum;
...
public class Random32States {

	public static void main(String[] args) throws InterruptedException {
		final char size = 100;
        final char numberOfStates = 32;
        ...
        for(int i = 0; i < 10; i++){
            ...
            Universe u = new Universe9Sum(initialCells, thresholds, numberOfStates, isCircular);
            universes.add(u);
        }
